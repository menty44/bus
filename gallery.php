...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="xres/images/logo.png" class="logo" alt="Bus booking software" /></a></h1>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="gallerycontainer">
			...
			<ul class="portfolio-area" style="width: 860px;">	
                   ...
                   <div class="home-portfolio-text">
					<h2 class="post-title-portfolio"><a href="#" rel="bookmark" title="Lorax">Lorax</a></h2>
...
<div id="footer">
<h4>0720106420 &bull; <a href="contact-us.php">View park towers 15th floor g.e.c   </a></h4>
	...
	<p>&copy; Copyright 2013 arif techonlogies Bus booking software | All Rights Reserved <br /></p>
</div>
